...
* On Abel: [vtk](http://www.vtk.org), [itk](https://itk.org) and [gmsh](http://gmsh.info). If you already have some of them intalled, please edit the following:[if gmsh installed](https://github.com/vildenst/In_Silico_Heart_Models/blob/1a9ece3b19afe5d9198ebe96d692f4e498ff47c1/mat2fem.py#L74) [if VTK installed](https://github.com/vildenst/In_Silico_Heart_Models/blob/1a9ece3b19afe5d9198ebe96d692f4e498ff47c1/software.sh#L60) [if ITK installed](https://github.com/vildenst/In_Silico_Heart_Models/blob/1a9ece3b19afe5d9198ebe96d692f4e498ff47c1/software.sh#L61).
